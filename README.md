...
Open `index.html` in your browser to view the site locally. All styling is in `styles.css`. Images and assets are in the `images/` folder.
...
Site is actively maintained and updated. For feedback or collaboration, use the contact links on the site.
